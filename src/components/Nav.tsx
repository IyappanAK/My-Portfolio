    ...
    >
      ...
      {!isTabletOrMobile && (
        <div className="text-[#FFFFFFFF] flex items-center space-x-16 rounded-md">
          <Link
            className="uppercase py-2 px-4 hover:text-sky-400  rounded-md outline outline-fuchsia-800 transition-all hover:outline-4 underline-none"
            style={{
              background:
      ...
      <AnimatePresence>
        {isTabletOrMobile && hamburgerState && (
          <motion.div
            className="font-poppins font-semibold text-[18px] leading-[23.4px]  text-white flex items-center flex-col text-xl space-y-4 mt-6  hover:text-sky-400  "
            key={`${hamburgerState}`}
            layout
          >
